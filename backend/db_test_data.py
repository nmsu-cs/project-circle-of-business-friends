...
for _ in range(5):
    ...
    # Create a profile
    profile = Profile(firstName=firstName, lastName=lastName, birthdate=date(year, month, day), gender=gender, interests=interests, career_interest=career_interest, education_level=education_level, major=major)
